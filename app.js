...
gameStart();
gameOver();
//collect cryptids to protect you from the other scary things in the woods -- like other humans
//cryptids can gift you items that help you on your way
//items make it easier to find other cryptids and befriend them
//before each turn check for health and hunger, and if a cryptid has a gift for you(Math.random, if number is 3 you get a health item, if number is 2 you get food, if number is 1 you get a sentimental item, any other # and you get nothing. math.random for which cryptid gives it to you)
//if health or hunger is 5 or under, warn the user
//turn is take Math.random * 10 steps, check your surroundings and get a random result (wolf nearby that cryptid protects you from, food that you can eat, etc), use an item (eat something, heal, etc)
//wincon = when you have made it out of the woods and have to leave your cryptid friends behind. if steps = 200, you escape the woods and the cryptids will always remember you
